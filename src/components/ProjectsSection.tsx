...
const projectsData = [
  ...
  { id: 8, title: 'Algive Solutions — Building the Digital Future', description: 'A digital agency platform delivering web apps, mobile apps, cloud solutions, and IT consulting for businesses across Africa and beyond.', technologies: ['React', 'Next.js', 'Node.js', 'MongoDB', 'AWS'], year: '2026', status: 'Live', link: 'https://www.algivesolutions.com/', highlights: ['Full-Stack Web & Mobile Delivery', 'Cloud Infrastructure & DevOps', 'UI/UX Design Systems'] },
  { id: 9, title: 'AfriLENS — Africa Through a New Lens', description: 'A full-featured news and media platform covering African news, business, culture, sports, and current affairs, with a custom admin dashboard for publishing articles.', technologies: ['React', 'TypeScript', 'Tailwind CSS', 'Admin CMS', 'Vite'], year: '2026', status: 'Live', link: 'https://afrilens.netlify.app/', highlights: ['Multi-Category News Publishing', 'Custom Admin Dashboard', 'Breaking News & Featured Stories'] },
];
